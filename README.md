...
1. **one minute** — 投げた言葉が少し浮いて、どんと落ちて砕ける。
   破片が横へ転がり、拾える案として散らばる。

   1分にするとは短くやることではなく、**断る理由が消えるところまでハードルを
   落とすこと**。だから案は「やる手前の一手」を取り出す方向で作る。
   道具に触るだけ／開くだけ／出してしまわない／前に座るだけ／構えだけ／
   場所に立つだけ／始めて10秒でやめる／やる気が出る前に。
   「〜を」があれば対象を掴んで、道具の側からも落とす。

   鍵が無くても出る（「〜したい」を辞書形に戻して型に当て、毎回ばらして6つ選ぶ）。
   鍵があると、Claudeの案が遅れて破片として降ってくる。
