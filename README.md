...
2. **after what** — くっつける相手を、塊で見渡して掴む

52の瞬間を、場面の塊で一度に出す。waking / washing / kitchen / leaving /
commute / desk / midday / coming home / supper / bath / bed の11。
**開いた時刻に近い塊が先頭に来て、そこだけ明るい。** 鍵があるときは、
その習慣に寄せた候補が `for this` として一番上に並ぶ。
一つずつ繰る作りは見つからなかったので捨てた。最後に write your own。
